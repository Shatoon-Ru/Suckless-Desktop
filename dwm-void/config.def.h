...
static const char *fonts[]          	   = { "Fira Sans:style=Regular:size=11:antialias=true", "Font Awesome 5 Pro:style=Solid:pixelsize=15:antialias=true", "Font Awesome 5 Brands:style=Solid:pixelsize=15:antialias=true", "Material Design Icons:Regular:pixelsize=20:antialias=true", "JoyPixels:size=14:antialias=true:autohint=true" };
