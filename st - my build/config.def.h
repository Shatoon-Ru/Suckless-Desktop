 ...
 */
static char *font = "Fira Code:pixelsize=12.25:antialias=true:autohint=true";
...
static Shortcut shortcuts[] = {
  ...
  { ShiftMask|ControlMask,  XK_Up,          zoom,           {.f = +1} },
  { ShiftMask|ControlMask,  XK_Down,        zoom,           {.f = -1} },
  { ShiftMask|ControlMask,  XK_K,           zoom,           {.f = +1} },
  { ShiftMask|ControlMask,  XK_J,           zoom,           {.f = -1} },
  { ShiftMask|ControlMask,  XK_U,           zoom,           {.f = +2} },
  { ShiftMask|ControlMask,  XK_D,           zoom,           {.f = -2} },
